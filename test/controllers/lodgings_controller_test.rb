...
class LodgingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lodging" do
    assert_difference('Lodging.count') do
      post lodgings_url, params: { lodging: { guest_name: @lodging.guest_name, room_id: @lodging.room_id } }
    end
  ...
  test "should update lodging" do
    patch lodging_url(@lodging), params: { lodging: { guest_name: @lodging.guest_name, room_id: @lodging.room_id } }
